...
let hannafruits = [
  {
    fruit: "apple",
    color: "green",
    image: "https://atlas-content-cdn.pixelsquid.com/stock-images/green-apple-1V28Mo6-600.jpg",
    descr: "An apple is a round, edible fruit produced by an apple tree (Malus domestica), a domesticated member of the rose family, and is one of the most widely cultivated tree fruits. Apples are known for their juicy green or red fruit and are used in various forms, including fresh eating, baking, and making juice, cider, and other products."
  },
  {
    fruit: "pear",
    color: "green",
    image: "https://static.vecteezy.com/system/resources/previews/046/828/888/non_2x/green-pear-fruit-png.png",
    descr: "Pears are fruits produced and consumed around the world, growing on a tree and harvested in late summer into mid-autumn. The pear tree and shrub are a species of genus Pyrus, in the family Rosaceae, bearing the pomaceous fruit of the same name."
  },
  {
    fruit: "mango",
    color: "red",
    image: "https://www.pngplay.com/wp-content/uploads/6/Red-Full-Mango-PNG.png",
